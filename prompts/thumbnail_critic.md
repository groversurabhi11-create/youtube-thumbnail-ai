...
comparisons, the Illustrator kept the scene clean and text-free, the Image
Generator caught rendering deviations. Your job is different: judge the
  ...
  "renders": [
    {
      ...
      "fidelity_notes": "Rendered as specified, no deviations observed."
    },
    {
      "rank": 2,
      ...
      "image_reference": "[placeholder]",
      "fidelity_notes": "Model initially rendered faint tick-mark numerals along the gauge's edge despite the explicit no-text instruction; regenerated with stronger negative-prompt emphasis ('no numerals, no tick labels, no units') until clean."
    },
    {
      "rank": 3,
  ...
  "evaluations": [
    {
      ...
      "metaphor_name": "The Suspicious Coin Flip",
      "criteria": {
        "educational_clarity": { "score": 9, "note": "A single glance reads as 'a repeating result plus a doubt forming' — this maps directly to the core intuition without needing the video or title for context." },
        ...
        "visual_hierarchy": { "score": 9, "note": "The coin is unmistakably the focal point; the ghost trail recedes appropriately into the background." },
        ...
        "mobile_readability": { "score": 7, "note": "The coin and crack read clearly at small size, but the faint ghost-trail may compress into an indistinct smear at very small (120px) thumbnail width." },
        "brand_alignment": { "score": 9, "note": "Clean, studio-lit, minimal — closely matches the channel's premium design philosophy." }
      },
      "overall_score": 8,
    ...
    },
    {
      ...
      "metaphor_name": "The Surprise Gauge",
      "criteria": {
        "educational_clarity": { "score": 7, "note": "Reads as 'a measurement is elevated,' but without a stronger visual anchor some viewers may not immediately connect it to 'surprise' specifically." },
